<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="pricing pricing-highlight">
            ...
            <div class="card" wire:model="cijdatas" wire:loading.remove wire:target='updateDataCij'>
                    <p class="text-center mx-5 pt-5 pb-5">
                        {{$cijdatas['message']}}<br>
                        <a class="btn btn-icon icon-left btn-primary mt-2" wire:model="cijdatas" wire:loading.remove wire:target='updateDataCij' wire:click.prevent="updateDataCij({{$datas->id}})" href="#"><i class="fas fa-sync-alt"></i>Cek Data Pinjaman</a>
                    </p>
            </div>
            <div class="card" wire:model="cijdatas" wire:loading wire:target='updateDataCij'>
                    <p class="text-center mx-5 pt-5 pb-5">
                        Proses cek data . . . <br>
                        <a class="btn disabled btn-primary btn-progress mt-2" href="#"><i class="fas fa-sync-alt"></i>Cek Data Pinjaman</a>
                    </p>
            </div>
